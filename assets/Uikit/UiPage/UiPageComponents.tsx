  ...
  type TUiButton = {
      ...
      <div className="grid grid-cols-12">
        <div className="col-span-4">
          ...
          <PdvButton theme="indigo-700" variant="outlined" onClick={() => clipboard(`<PdvButton theme='indigo-700' variant='outlined'></PdvButton>`)}>
            Copiar código
          </PdvButton>
        </div>
        <div className="col-span-4">
          <h6 className="my-2">theme: teal-500</h6>
          <PdvButton theme="teal-500" variant="outlined" onClick={() => clipboard(`<PdvButton theme='teal-500' variant='outlined'></PdvButton>`)}>
            Copiar código
          </PdvButton>
        </div>
        <div className="col-span-4">
          <h6 className="my-2">theme: blue-400</h6>
          <PdvButton theme="blue-400" variant="outlined" onClick={() => clipboard(`<PdvButton theme='blue-400' variant='outlined'></PdvButton>`)}>
            Copiar código
          </PdvButton>
        </div>
        <div className="col-span-4">
          <h6 className="my-2">theme: blue-100</h6>
          <PdvButton theme="blue-100" variant="outlined" onClick={() => clipboard(`<PdvButton theme='blue-100' variant='outlined'></PdvButton>`)}>
            Copiar código
          </PdvButton>
        </div>
        <div className="col-span-4">
          <h6 className="my-2">theme: orange-400</h6>
          <PdvButton theme="orange-400" variant="outlined" onClick={() => clipboard(`<PdvButton theme='orange-400' variant='outlined'></PdvButton>`)}>
            Copiar código
          </PdvButton>
        </div>
        <div className="col-span-4">
          <h6 className="my-2">theme: gray-500</h6>
          <PdvButton theme="gray-500" variant="outlined" onClick={() => clipboard(`<PdvButton theme='gray-500' variant='outlined'></PdvButton>`)}>
            Copiar código
          </PdvButton>
        </div>
        <div className="col-span-4">
          <h6 className="my-2">theme: black</h6>
          <PdvButton theme="black" variant="outlined" onClick={() => clipboard(`<PdvButton theme='black' variant='outlined'></PdvButton>`)}>
            Copiar código
          </PdvButton>
        </div>
      </div>
      ...
      <div className="grid grid-cols-12">
        <div className="col-span-4">
          <h6 className="my-2">theme: indigo-700</h6>
          <PdvButton theme="indigo-700" variant="default" onClick={() => clipboard(`<PdvButton theme='indigo-700' variant='default'></PdvButton>`)}>
            Copiar código
          </PdvButton>
        </div>
        <div className="col-span-4">
          <h6 className="my-2">theme: teal-500</h6>
          <PdvButton theme="teal-500" variant="default" onClick={() => clipboard(`<PdvButton theme='teal-500' variant='default'></PdvButton>`)}>
            Copiar código
          </PdvButton>
        </div>
        <div className="col-span-4">
          <h6 className="my-2">theme: blue-400</h6>
          <PdvButton theme="blue-400" variant="default" onClick={() => clipboard(`<PdvButton theme='blue-400' variant='default'></PdvButton>`)}>
            Copiar código
          </PdvButton>
        </div>
        <div className="col-span-4">
          <h6 className="my-2">theme: blue-100</h6>
          <PdvButton theme="blue-100" variant="default" onClick={() => clipboard(`<PdvButton theme='blue-100' variant='default'></PdvButton>`)}>
            Copiar código
          </PdvButton>
        </div>
        <div className="col-span-4">
          <h6 className="my-2">theme: orange-400</h6>
          <PdvButton theme="orange-400" variant="default" onClick={() => clipboard(`<PdvButton theme='orange-400' variant='default'></PdvButton>`)}>
            Copiar código
          </PdvButton>
        </div>
        <div className="col-span-4">
          <h6 className="my-2">theme: gray-500</h6>
          <PdvButton theme="gray-500" variant="default" onClick={() => clipboard(`<PdvButton theme='gray-500' variant='default'></PdvButton>`)}>
            Copiar código
          </PdvButton>
        </div>
        <div className="col-span-4">
          <h6 className="my-2">theme: black</h6>
          <PdvButton theme="black" variant="default" onClick={() => clipboard(`<PdvButton theme='black' variant='default'></PdvButton>`)}>
            Copiar código
          </PdvButton>
        </div>
      </div>
      ...
      <div className="grid grid-cols-12">
        <div className="col-span-4">
          ...
          <PdvButton theme="indigo-700" size="small" onClick={() => clipboard(`<PdvButton theme='indigo-700' size='small'></PdvButton>`)}>
            Copiar código
          </PdvButton>
        </div>
        <div className="col-span-4">
          <h6 className="my-2">medium (Default)</h6>
          <PdvButton theme="teal-500" size="medium" onClick={() => clipboard(`<PdvButton theme='teal-500' size='medium'></PdvButton>`)}>
            Copiar código
          </PdvButton>
        </div>
        <div className="col-span-4">
...
export const MultipleAccordionView = () => {
  ...
  type TPdvSimpleAccordion = {
    ...
    color?: TColors
      ...
      <PdvButton className="ml-auto mt-4 block" onClick={() => clipboard(`<PdvMultipleAccordion className="mt-2"  accordions={accordions} />`)}>
        Copiar código
      </PdvButton>
    </ComponentWrapper>
  )
