...
import { TDefaultInputProps } from "./Input/InputField";
...
const DateField = (props: TDatepicker) => {
 ...
 if (typeof icon === "string") dateIcon = <PdvIcons name={icon} color={iconColor ?? "blue-500"} />;
