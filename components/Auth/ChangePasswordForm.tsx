  ...
  return (
    <LoginScreen>
      <div className="flex w-80 flex-col items-center justify-center">
        ...
        <form className="m-2 w-full p-2" onSubmit={changePassForm.handleSubmit(changePassword)}>
          ...
          <InputField
            ...
            options={{
              ...
              validate: (value) => value === changePassForm.getValues('password') || 'Su contraseña no coincide con la previamente ingresada'
            }}
          />
        ...
        <PdvButton asLink href="/auth/login" theme="gray-500" variant="outlined" className="my-6 w-full" size="large" icon="ArrowLeft">
          Volver
        </PdvButton>
